...
class CategoriaInquilinoTest {

	// SUT
    CategoriaInquilinoCuidado categoria;
    CategoriaInquilinoCumplimiento categoria2;
    CategoriaInquilinoResponsabilidad categoria3;

    @BeforeEach
    void setUp() throws Exception {
        // Inicializamos la categoría con una lista de puntajes simulada
        List<Integer> puntajes = List.of(5, 4, 4, 3, 5, 2);
        categoria = new CategoriaInquilinoCuidado(puntajes);
        categoria2 = new CategoriaInquilinoCumplimiento(puntajes);
        categoria3 = new CategoriaInquilinoResponsabilidad(puntajes);
    }
