...
class CategoriaInmuebleTest {

	CategoriaInmuebleEstado categoria;
    CategoriaInmueblePrecio categoria2;
    CategoriaInmuebleUbicacion categoria3;

    @BeforeEach
    void setUp() throws Exception {
        // Inicializamos la categoría con una lista de puntajes simulada
        List<Integer> puntajes = List.of(5, 4, 4, 3, 5, 2);
        categoria = new CategoriaInmuebleEstado(puntajes);
        categoria2 = new CategoriaInmueblePrecio(puntajes);
        categoria3 = new CategoriaInmuebleUbicacion(puntajes);
    }
